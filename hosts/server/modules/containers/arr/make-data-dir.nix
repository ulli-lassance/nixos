{ config, ... }: {
  systemd.tmpfiles.rules = [
    ...
    "d ${config.settings.server.containerData}/soulseek 0755 ${config.settings.user.username} users -"
    "d ${config.settings.server.containerData}/soulseek/incomplete 0755 ${config.settings.user.username} users -"
    "d ${config.settings.server.containerData}/soulseek/complete 0755 ${config.settings.user.username} users -"
