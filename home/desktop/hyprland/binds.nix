...
in
{
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      # Rofi
      "${mainMod}, S, exec, ~/.config/rofi/scripts/toggle-main"
      "${mainMod}, TAB, exec, ~/.config/rofi/scripts/toggle-window-switcher"
      "${mainMod}, M, exec, ~/.config/rofi/scripts/toggle-power-menu"
